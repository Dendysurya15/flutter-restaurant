...
import 'package:restaurant/app/modules/dashboard_customer/views/dashboard_customer_view.dart';
import 'package:restaurant/app/modules/dashboard_owner/views/dashboard_owner_view.dart';
import 'package:restaurant/app/modules/profile/views/profile_view.dart';
...
class HomeController extends GetxController {
  ...
  final Map<String, List<Widget>> pageConfig = {
    ...
    "customer": [DashboardCustomerView(), ProfileView()],
  };
}
